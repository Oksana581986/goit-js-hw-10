...
fetch('https://api.thecatapi.com/v1/breeds')
    ...
    const showLoader = () => {
      ...
      breedSelect.style.display = true;
      catInfo.style.display = true;
      errorElement.style.display = 'none';
    };
    
    const hideLoader = () => {
      loader.style.display = 'none';
      breedSelect.style.display = false;
      catInfo.style.display = false;
      errorElement.style.display = 'none';
    };
    ...
    showLoader();
        ...
        catInfo.innerHTML = `
          <img src="${cat.url.reference_image_id}" alt="cat">
